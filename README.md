...
- Player names sit in matching outer corners, with larger +3 buttons near the middle. The + and − strokes have matching gaps from the number, adapting to smaller screens.
